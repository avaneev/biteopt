...
private:
	...
	int xhi2; ///< Current second highest cost parameter vector.
		///<
	double* xbuf; ///< Parameter vector storage.
		///<
	...
	/**
	 * Function finds highest-cost vector.
	 */
	...
	/**
	 * Function calculates centroid vector.
	 */
	...
	/**
	 * Function replaces highest-cost vector with a new vector.
	 *
	...
	/**
	 * Function evaluates parameter vector and applies value range clipping,
	...
	double eval( const double* const p )
	{
		...
		const double cost = optcost( Params );
